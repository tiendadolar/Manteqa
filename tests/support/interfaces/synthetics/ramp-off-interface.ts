export interface RampOffResponse {
  id: string;
  numberId: string;
  externalId?: string;
  userId: string;
...
export const isRampOffResponse = (obj: any): obj is RampOffResponse => {
  console.log('isRampOffResponse');
  return (
    obj &&
...
export const isDepositAddress = (obj: any): obj is DepositAddress => {
  ...
  return obj && typeof obj.address === 'string' && typeof obj.network === 'string';
};
...
export const isStage = (obj: any): obj is Stage => {
  ...
  if (obj.stageType === 'ORDER') {
    ...
    if (obj.disallowDebt !== undefined && typeof obj.disallowDebt !== 'boolean') return false;
  }
...
export const isDestination = (obj: any): obj is Destination => {
  ...
  return (
    ...
    (obj.accountType === undefined || obj.accountType === null || typeof obj.accountType === 'string') &&
