...
Then("Se obtienen las ordenes de la company", function (this: CustomWorld) {
...
Then("Se crea el Lock de precio", function (this: CustomWorld) {
  const response = this.response.body;
...
Then("Se crea la orden de compra", function (this: CustomWorld) {
  const response = this.response.body;
...
Then("Se opera el retiro", function (this: CustomWorld) {
