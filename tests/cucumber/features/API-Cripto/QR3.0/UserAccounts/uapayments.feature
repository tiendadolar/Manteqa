...
Feature: Sintéticos de Pago User Accounts
    ...
    Scenario Outline: User Account <country>: Ejecutar pago desde balance contra <against>
        ...
        Examples:
            ...
            # | 699a62cc6e3dd6fb25fa5e91 | Bolivia   | 100056108 | qr3BOBmanualamount            | 61.98  | QR-UserBalance-V1-n | USDT    | Ticket: C-0006
            ...
            # | 699a62cc6e3dd6fb25fa5e91 | Bolivia   | 100056108 | qr3BOBmanualamount            | 61.98  | QR-UserBalance-V1-n | BOB     | Ticket: C-0006
    ...
    Scenario Outline: User Account <country>: Ejecutar pago mediante deposito cripto contra <against>
        ...
        Examples:
            ...
            # | 69972e13e4c6077150f16ce8 | Bolivia   | 100056117 | qr3BOBmanualamount            | 61.98  | QR-V2-DESC-n | USDT    | Ticket: C-0006
