...
Feature: Onboarding User - V2
    ...
    Scenario: Onboarding de usuario de "<exchange>"
        ...
        Examples:
            | apiKEY                          | credential                | externalId    | email               | legalId       | exchange  | name    | surname         | sex | work     | birthDate  | maritalStatus | isPep | isFep | isFatca | phoneNumber | nationality | street               |
            | BG16CDQ-H9B4WK5-PQQN0W1-8HCD1QK | andresperalta@manteca.dev | test-nodesc-1 | herrerapm@gmail.com | 27-16749876-6 | ARGENTINA | MARIANA | HERRERA PIÑEIRO | F   | empleado | 1999-05-15 | Soltero       | false | false | false   | 112400152   | Argentina   | SAMUEL PIRES DE MELO |
