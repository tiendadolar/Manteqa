...
Feature: Onboarding User - V2
    ...
    Scenario: Onboarding de usuario de "<exchange>"
        ...
        Examples:
            | companyId                | credential                | externalId              | email                 | legalId     | exchange  | name  | surname | sex | work     | birthDate  | maritalStatus | isPep | isFep | isFatca | phoneNumber | nationality | street               | legalIdType |
            | 69addea7aa541dac7566fd9a | andresperalta@manteca.dev | user-account-arg-1-bind | abrilmariam@gmail.com | 27266382486 | ARGENTINA | MARIA | ABRIL   | M   | empleado | 1999-05-15 | Soltero       | false | false | false   | 112400152   | Argentina   | SAMUEL PIRES DE MELO |             |
