...
Feature: Lock Price Integrations
    ...
    Scenario Outline: Validate error withdraw cripto V2 response <case>
        ...
        Examples:
            ...
            | no funds                         | andresperalta@manteca.dev | PRAJYCG-71RM2H7-HSQK3BN-0NDD7MY | 100038864 | USDC  | 5      | 0x4cD0820ca71Bda1A6cEfe1A6D5a2F6E50D4370f2 | BASE    | 400        | NO_FUNDS       | Insufficient funds.                                                                                     |                                                                                                                                                                                                                    |
