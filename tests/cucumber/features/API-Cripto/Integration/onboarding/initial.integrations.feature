...
Feature: Initial Onboarding Integrations
    ...
    Scenario Outline: Validate Onboarding V2
        ...
        Examples:
            ...
            | B8HJ3SS-2JQM6XD-HW4Z877-KZCESAV | andresperalta@manteca.dev | Integrations-test-Arg | testargentinaonbauto@gmail.com | 20167417435 | ARGENTINA | MARIO GABRIEL | ABADI   | M   | empleado | 1999-05-15 | Soltero       | false | false | false   | 112400201   | Argentina   | Av. Corrientes |
    ...
    Scenario Outline: Validate error initial onboarding sending <case> V2
        ...
        Examples:
            ...
            | B8HJ3SS-2JQM6XD-HW4Z877-KZCESAV | used externalId                               | andresperalta@manteca.dev | externalIdRepeat    | inttestargrandom@gmail.com     | 27323361083 | ARGENTINA | MALENA | CANTEROS | M   | empleado | 1999-05-15 | Soltero       | false | false | false   | 112400201   | Argentina   | SAMUEL PIRES DE MELO | 409        | USER_EXISTS       | User already exists                  |
    ...
    Scenario Outline: Validate error Onboarding sending legalId mismatch <exchange> V2
        ...
        Examples:
            ...
            | B8HJ3SS-2JQM6XD-HW4Z877-KZCESAV | andresperalta@manteca.dev | Integrations-test-Arg | inttestarg@gmail.com | GAMA510210MTLRNR04 | PERU        | MALENA | CANTEROS | M   | empleado | 1999-05-15 | Soltero       | false | false | false   | 112400201   | Argentina   | SAMUEL PIRES DE MELO | 400        | BAD_REQUEST    | Bad request. | legalId has wrong value GAMA510210MTLRNR04. Value should be a valid Peruvian DNI, e.g., 10714510-4 or 434518267 or 10714510.                                              |
