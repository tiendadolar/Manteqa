...
Feature: Orders Integrations
    ...
    Scenario Outline: Validate error order response sending invalid non-empty <case>
        ...
        Examples:
            | case    | companyId                | externalId | sessionId             | asset   | side    | userAnyId | assetAmount | against | statusCode | internalStatus | message      | errors                                                                                                                                                                                 |
            | asset   | 683cce15397feba125068c9b | ext-n      | integrationc-orders-n | INVALID | BUY     | 100008501 | 10          | ARS     | 400        | BAD_REQUEST    | Bad request. | asset has wrong value INVALID. Possible values are DAI,USDT,BUSD,USDC,USDCB,ETH,BNB,ARB,POL,TRX,UST,AUST,BTC,LUNA,LUNA2,SOL,MATIC,NUARS,WLD,USDL,SDAI,AXS,MANA,ENJ,SAND,...and 8 more. |
            | against | 683cce15397feba125068c9b | ext-n      | integrationc-orders-n | USDT    | BUY     | 100008501 | 10          | INVALID | 400        | BAD_REQUEST    | Bad request. | against has wrong value INVALID. Possible values are ARS,USD,CLP,COP,BRL,GTQ,CRC,PUSD,MXN,PHP,PEN,PYG,BOB,EUR,USDCCL,DAI,USDT,BUSD,USDC,USDCB.                                         |
            | side    | 683cce15397feba125068c9b | ext-n      | integrationc-orders-n | USDT    | INVALID | 100008501 | 10          | ARS     | 400        | BAD_REQUEST    | Bad request. | side has wrong value INVALID. Possible values are BUY,SELL.                                                                                                                            |
    ...
    Scenario Outline: Validate error order response for fiat exchange mismatch <case>
        ...
        Examples:
            | case                  | companyId                | externalId | sessionId             | asset | side | userAnyId | assetAmount | against | statusCode | internalStatus         | message                                        |
            | ARS user ordering BRL | 683cce15397feba125068c9b | ext-n      | integrationc-orders-n | USDT  | BUY  | 100008501 | 5           | BRL     | 409        | FIAT_EXCHANGE_MISMATCH | User exchange and operation fiat do not match. |
            | ARS user ordering CLP | 683cce15397feba125068c9b | ext-n      | integrationc-orders-n | USDT  | BUY  | 100008501 | 5           | CLP     | 409        | FIAT_EXCHANGE_MISMATCH | User exchange and operation fiat do not match. |
            | ARS user selling BRL  | 683cce15397feba125068c9b | ext-n      | integrationc-orders-n | USDT  | SELL | 100008501 | 5           | BRL     | 409        | FIAT_EXCHANGE_MISMATCH | User exchange and operation fiat do not match. |
