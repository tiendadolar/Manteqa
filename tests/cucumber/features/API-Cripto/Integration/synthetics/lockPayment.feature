...
Feature: Lock Payment Integrations
    ...
    Scenario Outline: Validate error lock payment with sender response sending invalid <case>
        ...
        Examples:
            ...
            | user status | B8HJ3SS-2JQM6XD-HW4Z877-KZCESAV | PIX | BRAZIL   | 40842073817 | DARIO AUGUSTO |          | 100036843 | qr3manualamount    | USDT    | 10     | ARGENTINA  | 400        | DNI_NOT_VALIDATED | DNI not validated. |                                                                                                                                                                                                                                                                                                                       |
