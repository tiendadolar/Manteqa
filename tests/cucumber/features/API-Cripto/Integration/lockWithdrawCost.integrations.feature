...
Feature: Lock Withdraw Cost Integrations
    ...
    Scenario Outline: Validate error lock withdraw cost for unsupported asset on network <case>
        ...
        Examples:
            | case           | companyId                | userAnyId | asset | network | address                                    | statusCode | internalStatus  | message                               |
            | WLD on BINANCE | 684b2f25dcca16d5557fd8b2 | 100009352 | WLD   | BINANCE | 0x7921319332714EBea5c1219439c34309e600DF54 | 400        | INVALID_NETWORK | Network does not support given asset. |
