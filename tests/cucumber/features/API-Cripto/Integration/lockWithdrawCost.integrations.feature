...
Feature: Lock Withdraw Cost Integrations
    ...
    Scenario Outline: Validate error lock withdraw cost response <case>
        ...
        Examples:
            ...
            | sending empty userAnyId      | 95ZZHZT-CRH4PM9-K1NQA51-DXYVTX6 | 100009352 | USDT  | ETHEREUM | 0x7921319332714EBea5c1219439c34309e600DF54 | 400        | BAD_REQUEST    | Bad request. | userAnyId is missing.                                                                                                                                                           |
